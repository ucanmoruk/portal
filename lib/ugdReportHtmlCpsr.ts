...
type ReportVariant = ReportLanguage | "cpsr";
...
const reportCopy = {
  ...
  en: {
    ...
    density: "Density",
    viscosity: "Viscosity",
    waterSolubility: "Solubility in water",
    otherSolubility: "Solubility in other solvents and oils",
...
export function renderUgdReportHtmlCpsr(input: UGDReportInput) {
